"""
Scraper para Olímpica Colombia. VTEX API (igual que Éxito/Jumbo).
"""
...
API_BASE = "https://www.olimpica.com/api/catalog_system/pub/products/search"
        ...
        for item in items:
            ...
            try:
                ...
                prod = {
                    "nombre": nombre,
                    "precio": float(precio),
                    "url": f"https://www.olimpica.com/{item.get('linkText','')}/p",
...
def scrape_todo():
    print("=== Iniciando scraper Olimpica ===")
    total_global = 0
